...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  let obj_2 = {length: 4, width: 5, height: 5};
  const cuboid = new CuboidMaker(obj_2);
...
let obj_3 = {length: 4, width: 5, height: 5};
const cuboidTwo = new CuboidMaker(obj_3);
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log(cuboidTwo.volume(cuboidTwo)); // 100
console.log(cuboidTwo.surfaceArea(cuboidTwo)); // 130
